-- slashcommands.lua
local PWB = PizzaWorldBuffsDoubleTime
...
SlashCmdList['PIZZAWORLDBUFFS'] = function(args, editbox)
  ...
  if command == 'logout' then
    ...
    if PWB_config.autoLogout then
      message = T
          ['Auto-logout after receiving next buff enabled. This will be disabled again the next time you relog or reload your UI.']
  ...
  if command == 'exit' then
    ...
    if PWB_config.autoExit then
      message = T
          ['Auto-exit after receiving next buff enabled. This will be disabled again the next time you relog or reload your UI.']
      if PWB_config.autoLogout then
  ...
  PWB:PrintClean(PWB.Colors.primary ..
    '   /wb|r lock ' .. (PWB_config.lock and 1 or 0) .. PWB.Colors.grey .. ' - ' .. T['Lock PizzaWorldBuffs frame'])
  PWB:PrintClean(PWB.Colors.primary ..
    '   /wb|r header ' .. (PWB_config.header and 1 or 0) .. PWB.Colors.grey .. ' - ' .. T['Show PizzaWorldBuffs header'])
  PWB:PrintClean(PWB.Colors.primary ..
    '   /wb|r dmf ' .. (PWB_config.dmf and 1 or 0) .. PWB.Colors.grey .. ' - ' .. T['Show Darkmoon Faire location'])
  PWB:PrintClean(PWB.Colors.primary ..
    '   /wb|r all ' ..
    (PWB_config.allFactions and 1 or 0) .. PWB.Colors.grey .. ' - ' .. T['Show both factions\' world buff timers'])
  PWB:PrintClean(PWB.Colors.primary ..
    '   /wb|r mapHeads ' ..
    (PWB_config.mapHeads and 1 or 0) .. PWB.Colors.grey .. ' - ' .. T['Show Ony/Nef head timers on the SW/OG map'])
  PWB:PrintClean(PWB.Colors.primary ..
    '   /wb|r tents ' ..
    (PWB_config.tents and 1 or 0) .. PWB.Colors.grey .. ' - ' .. T['Show tent locations on the world map'])
  PWB:PrintClean(PWB.Colors.primary ..
    '   /wb|r tentStyle ' ..
    PWB_config.tentStyle .. PWB.Colors.grey .. ' - ' .. T['Choose between tent styles 1, 2, 3, 4, 5, 6, 7 and 1337'])
  PWB:PrintClean(PWB.Colors.primary ..
    '   /wb|r tentAlert ' ..
    PWB_config.tentAlert .. PWB.Colors.grey .. ' - ' .. T['Alert about new tents in your zone (1) or anywhere (2)'])
  PWB:PrintClean(PWB.Colors.primary ..
    '   /wb|r whereTents ' .. PWB.Colors.grey .. '- ' .. T['List all currently known tent locations'])
  PWB:PrintClean(PWB.Colors.primary ..
    '   /wb|r logout ' ..
    (PWB_config.autoLogout and 1 or 0) ..
    PWB.Colors.grey .. ' - ' .. T['Log out automatically after receiving next buff'])
  PWB:PrintClean(PWB.Colors.primary ..
    '   /wb|r exit ' ..
    (PWB_config.autoExit and 1 or 0) ..
    PWB.Colors.grey .. ' - ' .. T['Exit game automatically after receiving next buff'])
  PWB:PrintClean(PWB.Colors.primary ..
    '   /wb|r reset ' .. PWB.Colors.grey .. '- ' .. T['Reset PizzaWorldBuffs frames to their default positions'])
  PWB:PrintClean(PWB.Colors.primary ..
    '   /wb|r fontSize ' .. PWB_config.fontSize .. PWB.Colors.grey .. ' - ' .. T['Set font size'])
  PWB:PrintClean(PWB.Colors.primary ..
    '   /wb|r align ' .. PWB_config.align .. PWB.Colors.grey .. ' - ' .. T['Align text left/center/right'])
  PWB:PrintClean(PWB.Colors.primary ..
    '   /wb|r horizontal ' .. PWB.Colors.grey .. '- ' .. T['Set text orientation to horizontal']) -- New
  PWB:PrintClean(PWB.Colors.primary ..
    '   /wb|r vertical ' .. PWB.Colors.grey .. '- ' .. T['Set text orientation to vertical'])     -- New
  PWB:PrintClean(PWB.Colors.primary ..
    '   /wb|r dmfbuffs ' .. PWB.Colors.grey .. '- ' .. T['Show list of Darkmoon Faire buffs'])
