...
## Install
> [!IMPORTANT]
> Remove the original PizzaWorldBuffs Addon, they will not work well together. Maybe keep a backup somewhere

1. Download and extract [latest version](https://github.com/LittleMolly/PizzaWorldBuffsDoubleTime/releases/tag/1.7.0)
